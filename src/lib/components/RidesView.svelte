                    ...
                    <tr>
                        ...
                        <td>
                            <div class="flex gap-2">
                                <button on:click={() => downloadRide(ride)} class="btn btn-sm btn-primary">Download</button>
                                <button on:click={() => handleDelete(ride)} class="btn btn-sm btn-error">Delete</button>
                            </div>
                        </td>
                    </tr>
                {/each}
